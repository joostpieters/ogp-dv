 ...
 * @invar  The current number of action points of each worm must be a number of
...
public class Worm extends GameObject {
     ...
     * 		 | setRadius(radius) 
     * @effect The number of action points of this new worm are set to 
	 ...
	 */
	@Raw 
	public Worm(World world, double x, double y, double direction, double radius,
		String name) 
	 ...
	 *       | setMaxActionPoints(getMaxActionPoints())
	 */
     ...
     *         nr of action points.
     *       | result ==
     *       |   (actionPoints >= minActionPoints) && (actionPoints <= getMaxActionPoints())	
     */
	@Raw
    public boolean canHaveAsActionPoints(int actionPoints) {
        return actionPoints >= minActionPoints && 
