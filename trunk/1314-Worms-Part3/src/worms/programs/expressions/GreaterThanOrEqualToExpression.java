...
public class GreaterThanOrEqualToExpression extends Expression<BoolType> {

	private Expression<? extends Type> e1;
	private Expression<? extends Type> e2;

	public GreaterThanOrEqualToExpression(Program program, int line, int column, Expression<? extends Type> e1, 
	...
	public BoolType evaluate() {
		...
		return new BoolType( Util.fuzzyGreaterThanOrEqualTo( double1.getValue(), double2.getValue()) );
