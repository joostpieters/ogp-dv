...
public class AddExpression extends Expression<DoubleType> {

	private Expression<? extends Type> e1;
	private Expression<? extends Type> e2;

	public AddExpression(Program program, int line, int column, Expression<? extends Type> e1, Expression<? extends Type> e2) {
